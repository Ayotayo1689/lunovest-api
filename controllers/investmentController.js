...
// //         // Calculate profit for this plan (only if there's invested amount)
// //         if (planData.totalAmountInvested > 0) {
// //           const daysSinceCreation = Math.floor((currentTime - planData.createdAt.toDate()) / (1000 * 60 * 60 * 24))
// //           const dailyAmountEarned = (planData.totalAmountInvested * planData.dailyPercentage) / 100
// //           const planTotalProfit = daysSinceCreation * dailyAmountEarned
...
// //       // Get all active investment plans with approved investments
// //       const plansSnapshot = await db
// //         .collection("investmentPlans")
// //         .where("isActive", "==", true)
// //         .where("totalAmountInvested", ">", 0)
// //         .get()
...
// //         // Check if we need to calculate profit for today
// //         const daysSinceLastCalculation = Math.floor((currentTime - lastCalculated) / (1000 * 60 * 60 * 24))
...
// //             description: `Daily profit from investment plan: ${planData.investmentPlanName}`,
// //             status: "success",
// //             tags: ["daily profit"],
// //             createdAt: currentTime,
// //           }
...
// //       const { response, statusCode } = generateResponse(
// //         true,
// //         `Daily profits calculated successfully for ${result.processedPlans} plans`,
// //         result,
// //       )
// //       res.status(statusCode).json(response)
// //     } catch (error) {
...
//       // FIXED: Use separate queries to avoid index requirement
//       // First get all active plans
...
//           // Changed from daily to every 2 minutes for testing
//           const dailyAmountEarned = (planData.totalAmountInvested * planData.dailyPercentage) / 100
//           const newTotalGained = planData.totalAmountGained + dailyAmountEarned
